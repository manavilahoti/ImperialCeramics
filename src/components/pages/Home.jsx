    ...
    <div className="px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative mb-12 bg-white rounded-lg shadow-xl overflow-hidden">
          <button className="absolute left-0 top-1/2  -translate-y-1/2 px-4 py-2 rounded-r-full bg-gray-800 text-white" onClick={previousImage}>
            &lt;
          </button>
          <img src={images[currentImageIndex]} alt={`Image ${currentImageIndex + 1}`} className="w-full object-contain" />
          <button className="absolute right-0 top-1/2  -translate-y-1/2 px-4 py-2 rounded-l-full bg-gray-800 text-white" onClick={nextImage}>
            &gt;
          </button>
        </div>
